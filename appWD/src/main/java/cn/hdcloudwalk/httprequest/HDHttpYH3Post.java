...
public class HDHttpYH3Post extends AsyncTask<String, Integer, String> {
    ...
    public HDHttpYH3Post(Context context, String sfzh, String xm, String cardNum, String mainjsessionid, Handler handler, String methodName) {
...
//        String lic = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?><root><dwdm>20</dwdm><dwmc>光电子</dwmc><xtzch>100001920170413095942000000361</xtzch><xtmc>光电子</xtmc><lic>93D1ECE650983665DE651302DC21AAD2</lic></root>";
        ...
        String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?><root><txcode>05004</txcode><zjlx>0</zjlx><gmsfhm>" + sfzh + "</gmsfhm><xm>" + xm + "</xm><kh>" + cardNum + "</kh></root>";
