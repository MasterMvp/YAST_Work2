...
public class HDHttpYH4Post extends AsyncTask<String, Integer, String> {
    ...
    public HDHttpYH4Post(Context context, String sfzh, String xm, String cardNum, String phoneNum, String mainjsessionid, Handler handler, String methodName) {
...
//		String endPoint = "https://192.168.1.112:8443/hdafis/services/hdWebService";
        ...
        String endPoint = "https://202.111.188.117:8443/hdafis/services/hdBankWebService";
        // SOAP Action
...
//        String lic = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?><root><dwdm>20</dwdm><dwmc>光电子</dwmc><xtzch>100001920170413095942000000361</xtzch><xtmc>光电子</xtmc><lic>93D1ECE650983665DE651302DC21AAD2</lic></root>";
        ...
        String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?><root><txcode>05001</txcode><zjlx>0</zjlx><gmsfhm>" + sfzh + "</gmsfhm><xm>" + xm + "</xm><kh>" + cardNum + "</kh><dhhm>" + phoneNum + "</dhhm></root>";
