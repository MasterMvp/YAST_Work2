...
public class HDHttpBadPost extends AsyncTask<String, Integer, String> {
     ...
     */
    public HDHttpBadPost(Context context, String sfzh, String xm, String mainjsessionid, Handler handler, String methodName) {
...
//        String xml = "<?xml version=\"1.0\" encoding=\"UTF-8\" ?><root><gmsfhm>" + sfzh + "</gmsfhm><xm>" + xm + "</xm><dhhm>" + dhhm + "</dhhm><ywdm></ywdm><ywmc></ywmc></root>";
        String xml = "{'gmsfhm':'" + sfzh + "','xm':'" + xm + "'}";
        Log.e("HDHttpBadPost", "请求数据:" + xml);
