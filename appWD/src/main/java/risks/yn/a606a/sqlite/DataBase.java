...
public class DataBase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        //用户表    id,名字,性别,部门,身份证号,彩色照片,近红外照片,指纹特征值1,指纹特征值2,密码,创建时间，彩色照片特征值，近红外照片特征值
        String sql5 = "create table risk(_id integer primary key autoincrement,name varchar,gender varchar,department varchar,cardNum varchar,address varchar,birthday varchar,nation varchar,idphoto varchar,photo varchar,finger1 varchar,message varchar,createTime varchar,phonenum varchar);";
