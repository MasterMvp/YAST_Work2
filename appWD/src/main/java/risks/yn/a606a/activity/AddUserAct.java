...
//                idReader = new A606LReader(AddUserAct.this);
//            } else if (Build.MODEL.toUpperCase().equals("JWZD-606A")) {
//                idReader = new A606AReader(AddUserAct.this);
//            } else {
//                idReader = new A606AReader(AddUserAct.this);
//            }
...
//        //天成指纹
//        if (Build.MODEL.toUpperCase().equals("JWZD-606")) {
//             Main2Activity.fingerExt.PowerOnReader();
//        } else {
//             Main2Activity.fingerExt.PowerOnFinger606A();
//        }
//         Main2Activity.fingerExt.initUsbFinger();
//    }
//
//    public void releaseFingerPrinter() {
//        isExitVaildFinger = true;
//        if ( Main2Activity.fingerExt != null) {
//             Main2Activity.fingerExt.UsbFingerClose();
//        }
//        if (Build.MODEL.toUpperCase().equals("JWZD-606")) {
//            //606 and 800
//             Main2Activity.fingerExt.PowerOffReader();
//        } else {
//             Main2Activity.fingerExt.PowerOffFinger606A();//606A指纹下电
//        }
//    }
