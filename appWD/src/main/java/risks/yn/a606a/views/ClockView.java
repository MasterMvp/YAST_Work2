...
import risks.yn.a606a.activity.MainActivity;
...
//        centerY = height / 2 + getPaddingTop();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < 12; i++) {
            ...
            canvas.drawLine(
                    centerX,
                    centerY - radius + MARK_GAP - 5,
                    centerX,
                    centerY - radius + MARK_GAP + MARK_LENGTH - 10,
                    markPaint);
        ...
        int mWay = calendar.get(Calendar.DAY_OF_WEEK);// 获取当前日期的星期
        String timer1 = mYear + " - " + mMonth + " - " + mDay ;
        MainActivity.setTime(timer1, mWay);
